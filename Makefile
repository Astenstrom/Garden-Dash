PRODUCT_NAME       = GardenDash
SOURCES            = main.c myLib.c farmer.c BG512x512.c splash.c instructions.c pause.c win.c lose.c collisionmap.c HarvestMoon.c harvest.c pikachuAnimated.c bg2.c secret.c
